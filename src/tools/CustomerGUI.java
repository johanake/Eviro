...
public class CustomerGUI extends JPanel implements Tool {
	...
	private JTextField[] txtInfoAll = { txtIdNbr, txtName, txtAddress, txtCity, txtZipNbr, txtPhoneNbr, txtEmail,
			txtVatNbr };
	...
	public CustomerGUI(ClientController controller, GUIController guiController) {
...
//			}
			...
			HashMap<String, String> customerData = rows.get(0);
	...
	private class ButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == btnSave) {
				controller.updateCustomer(Integer.parseInt(lblIdNbr.getText()), txtName.getText(), txtAddress.getText(),
						Integer.parseInt(txtZipNbr.getText()), txtCity.getText(), txtPhoneNbr.getText(),
						txtEmail.getText(), Integer.parseInt(txtVatNbr.getText()));
			}
	...
	private class ListGUI extends JPanel implements Tool {
