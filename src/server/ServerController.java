...
public class ServerController {
	...
	/**
	 * Builds a SELECT-query with the customerId from the incoming customer-object, executes the query and sends the
	 * returning ResultSet to createCustomerList which returns an ArrayList<Customer> with a single Customer-object that
	...
	/**
	 * Builds a SELECT-query from all current information in the incoming customer-object, executes the query and sends
	 * the returning ResultSet to createCustomerList which returns an ArrayList<Customer> with all Customer-objects that
	 * are created from the ResultSet
	 * 
